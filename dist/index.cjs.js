...
var LangSelector = function (_a) {
    ...
    return (React__default['default'].createElement(Dropdown, { position: "top-right", height: "500px", top: "50px", target: React__default['default'].createElement(Button, { variant: "text", startIcon: React__default['default'].createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
