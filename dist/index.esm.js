...
var LangSelector = function (_a) {
    ...
    return (React.createElement(Dropdown, { position: "top-right", height: "500px", top: "50px", target: React.createElement(Button, { variant: "text", startIcon: React.createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
